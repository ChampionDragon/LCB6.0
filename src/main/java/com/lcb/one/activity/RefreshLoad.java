...
import com.lcb.one.adapter.MyAdapter;
import com.lcb.one.bean.Student;
import com.lcb.one.refreshlibrary.MeiTuanRefreshViewHolder;
import com.lcb.one.refreshlibrary.MoocRefreshViewHolder;
import com.lcb.one.refreshlibrary.RefreshLayout;
import com.lcb.one.refreshlibrary.StickinessRefreshViewHolder;
import com.lcb.one.refreshlibrary.WeiBoRefreshViewHolder;
 ...
 **/
public class RefreshLoad extends AutoLayoutActivity implements View.OnClickListener, RefreshLayout.RefreshLayoutDelegate {
...
//        TintBarUtil.setTransparent(this);
        ...
        findViewById(R.id.back_refreshload).setOnClickListener(this);

        refreshLayout = ((RefreshLayout) findViewById(R.id.refreshload_refreshload));
        mLV = ((ListView) findViewById(R.id.refreshload_lv));
        mList = new ArrayList<>();
...
//        initStickinessRefreshLayout();//粘性下啦刷新
    ...
    private void initData() {
        for (int i = 0; i < 50; i++) {
            final Student s = new Student(i, "下啦刷新 - Refresh" + i, "学生号" + i);
            mList.add(s);
        }
    ...
    private void initRefreshLayout() {
        ...
        // 设置正在java多时的文本
        refreshViewHolder.setReleaseRefreshText("释放更新   上次更新时间：" +
                new SimpleDateFormat("MM月dd日 HH分mm秒").format(System.currentTimeMillis()));
        ...
        if (true) {//true改为判断网络
            ...
            new AsyncTask<Void, Void, Void>() {
                ...
                protected void onPostExecute(Void aVoid) {
                    ...
                    for (int i = 0; i < 5; i++) {
                        final Student s = new Student(i, "下啦刷新 - REFRESH" + System.currentTimeMillis(),
                                "身份证 ：刷新" + System.currentTimeMillis());
                        newList.add(s);
                    }
        ...
        if (true) {//true改为判断网络
            ...
            new AsyncTask<Void, Void, Void>() {
                ...
                protected void onPostExecute(Void aVoid) {
                    ...
                    for (int i = 0; i < 5; i++) {
                        final Student s = new Student(i, "加载更多 -LOADMORE" + System.currentTimeMillis(),
                                "身份证 ：加载" + System.currentTimeMillis());
                        mList.add(s);
                    }
                    mAdapter.setData(mList);
                }
