...
public class TableLayout extends LinearLayout implements TableColumn.Callback {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            tableRowHeight = typedArray.getDimensionPixelSize(R.styleable.TableLayout_tableRowHeight, (int) DpUtil.dip2px(getResources(), 36));
            ...
            tableTextSize = typedArray.getDimensionPixelSize(R.styleable.TableLayout_tableTextSize, (int) DpUtil.dip2px(getResources(), 12));
            ...
            tableMode = 0;
            tableRowHeight = (int) DpUtil.dip2px(getResources(), 36);
            tableDividerSize = 1;
            tableDividerColor = Color.GRAY;
            tableColumnPadding = 0;
            tableTextGravity = 0;
            tableTextSize = (int) DpUtil.dip2px(getResources(), 12);
