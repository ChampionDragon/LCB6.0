...
public class MyAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            AutoUtils.autoSize(convertView);//在build.gradle里添加compile 'com.zhy:autolayout:1.4.5'
            //相关资料：https://blog.csdn.net/javaandroid730/article/details/53511123
        }else {
